...
web_view(){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("किसान सम्मान योजना"),elevation: 0,),
      body: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                ElevatedButton(
                  onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (context) => Web_View(url: 'https://pmkisan.gov.in/RegistrationFormnew.aspx',)));},
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(Colors.redAccent),
                    side: MaterialStateBorderSide.resolveWith(
                            (states) => BorderSide(width: 1, color: Theme.of(context).primaryColor)),
